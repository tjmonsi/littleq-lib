 ...
 */
LittleQ.allowCheck = function (collection, userId, document, fieldNames, modifier) {
...
Meteor.Collection.prototype.allowCheck = function (userId, document, fieldNames, modifier) {
  LittleQ.allowCheck(this, userId, document, fieldNames, modifier);
};

/**
 * Global schemas object. Note: not reactive, won't be updated after initialization
 * @namespace LittleQ.schemas
 */
LittleQ.schemas = {};
